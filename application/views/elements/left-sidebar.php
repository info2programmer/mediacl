   ...
   <!-- <li class="treeview"><a class="waves-effect waves-dark" href="#!"><i class="icon-film"></i> <span> Manage Expense & ROI</span><i class="icon-arrow-down"></i></a>
    ...
    <li class="nav-level">Accounting</li>
     <li class="treeview"><a class="waves-effect waves-dark" href="#!"><i class="icon-film"></i> <span> Account Management</span><i class="icon-arrow-down"></i></a>
      ...
      <li><a class="waves-effect waves-dark" href="<?php echo base_url();?>accounts/cashbook"><i class="icon-arrow-right"></i> Cash Book</a></li>
        ...
        <?php if($this->session->userdata('account_type')=="admin"): ?><li><a class="waves-effect waves-dark" href="<?php echo base_url();?>accounts/ProfitLoss"><i class="icon-arrow-right"></i> Profit-Loss Report</a></li><?php endif; ?>
    ...
    <li class="treeview"><a class="waves-effect waves-dark" href="#!"><i class="icon-film"></i> <span> Sales Reports</span><i class="icon-arrow-down"></i></a>
      <ul class="treeview-menu">
        ...
        <li><a class="waves-effect waves-dark" href="<?php echo base_url();?>reports/PersonSaleReport"><i class="icon-arrow-right"></i>Sale Report / Customer</a></li>
