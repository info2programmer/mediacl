            ...
            <div class="row">
                <div class="main-header">
                    ...
                    <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                        ...
                        <li class="breadcrumb-item">Sale Report / Customer
                        </li>
                    </ol>
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-header-text">Search Sale / Customer Details</h5>
                            
                        </div>
                        
                        <!-- end of modal -->
						<form name="companyform" id="signupform" method="post" action="<?php echo base_url();?>index.php/Reports/SearchpersonReport" enctype="multipart/form-data" autocomplete="off">
