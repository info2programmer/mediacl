                        ...
                        <div class="row">
                            <div class="col-xs-12 bill-item-list">
                                ...
                                <div class="row">
                                    <div class="col-sm-1">
                                        <div class="md-input-wrapper multisugg">
                                            <input type="text" class="md-form-control required" placeholder="Item" name="item-name[]"/>
                                            <ul class="md-form-control">
                                    ...
                                    <div class="col-sm-1">
                                        <div class="md-input-wrapper">
                                            <input type="text" class="md-form-control required" placeholder="HSN" name="item-hsn[]"/>
                                        </div>
                                    </div>
                                    <div class="col-sm-1">
                                        <div class="md-input-wrapper">
                                    ...
                                    <div class="col-sm-2">
                                        <div class="row">
                                        	<div class="col-sm-4">
                                                <div class="md-input-wrapper">
                                                    <input type="text" class="md-form-control required" placeholder="MRP" name="item-mrp[]"/>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="md-input-wrapper">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="md-input-wrapper" style="width: 54px;">
                                    ...
                                    <div class="col-sm-1">
                                        <div class="md-input-wrapper">
                                            <input type="text" class="md-form-control required" placeholder="IGST" name="item-isgt[]"/>
                                        </div>
                                    </div>
                                    <div class="col-sm-1">
                                        <div class="md-input-wrapper">
...
<script>
    ...
    var totall = 0;
    $('[name*=price], [name*=quantity], [name*=total], [name*=isgt], [name*=gst], [name*=ost], [name*=totsal]').on('input', function () {
        totall = 0;
        if ($(this).is('[name*=price]') || $(this).is('[name*=isgt]') || $(this).is('[name*=gst]') || $(this).is('[name*=ost]')) {
            p = parseFloat($(this).parent().parent().parent().find('[name*=price]').val()) || 0;
            q = parseFloat($(this).parent().parent().parent().find('[name*=quantity]').val()) || 0;
            s = parseFloat($(this).parent().parent().parent().find('[name*=isgt]').val()) || 0;
            gs = parseFloat($(this).parent().parent().parent().find('[name*=gst]').val()) || 0;
			sgs = parseFloat($(this).parent().parent().parent().find('[name*=ost]').val()) || 0;
            if ((p || p == 0) && (q || q == 0)) {
                $(this).parent().parent().parent().find('[name*=total]').val(p * q)
            }
            if ((s || s == 0) && (gs || gs == 0) && (sgs || sgs == 0)) {
                $(this).parent().parent().parent().find('[name*=totsal]').val((p*q) + (((p*q) * s) / 100) + (((p*q) * gs) / 100)+ (((p*q) * sgs) / 100))
            }
        } else if ($(this).is('[name*=quantity]')) {
            p = parseFloat($(this).parent().parent().parent().parent().parent().find('[name*=price]').val()) || 0;
            q = parseFloat($(this).parent().parent().parent().parent().parent().find('[name*=quantity]').val()) || 0;
            s = parseFloat($(this).parent().parent().parent().parent().parent().find('[name*=isgt]').val()) || 0;
            gs = parseFloat($(this).parent().parent().parent().parent().parent().find('[name*=gst]').val()) || 0;
			sgs = parseFloat($(this).parent().parent().parent().parent().parent().find('[name*=ost]').val()) || 0;
            if ((p || p == 0) && (q || q == 0)) {
                $(this).parent().parent().parent().parent().parent().find('[name*=total]').val(p * q)
            }
            if ((s || s == 0) && (gs || gs == 0) && (sgs || sgs == 0)) {
                $(this).parent().parent().parent().parent().parent().find('[name*=totsal]').val((p*q) + (((p*q) * s) / 100) + (((p*q) * gs) / 100)+ (((p*q) * sgs) / 100))
            }
        }
    ...
    function addItemRow(ths) {
        ...
        addable = '<div class="row">'
            + '<div class="col-sm-1">'
            + '<div class="md-input-wrapper multisugg">'
            + '<input type="text" class="md-form-control required" placeholder="Item" name="item-name[]"/><span class="md-line"></span>'
            + '<ul class="md-form-control">'
			<?php foreach($items as $itemN){?>
            +'<li><?php echo $itemN['item_name'];?></li>'
            <?php }?>
			...
			+ '<div class="col-sm-1">'
            + '<div class="md-input-wrapper">'
            + '<input type="text" class="md-form-control required" placeholder="HSN" name="item-hsn[]"/><span class="md-line"></span>'
            + '</div>'
            + '</div>'
            + '<div class="col-sm-1">'
            + '<div class="md-input-wrapper">'
			...
			+ '<div class="col-sm-4">'
            + '<div class="md-input-wrapper">'
            + '<input type="text" class="md-form-control required" placeholder="MRP" name="item-mrp[]"/><span class="md-line"></span>'
            + '</div>'
            + '</div>'
            + '<div class="col-sm-4">'
            + '<div class="md-input-wrapper">'
			...
			+ '<div class="col-sm-1">'
            + '<div class="md-input-wrapper">'
            + '<input type="text" class="md-form-control required" placeholder="IGST" name="item-isgt[]"/><span class="md-line"></span>'
            + '</div>'
            + '</div>'
            + '<div class="col-sm-1">'
            + '<div class="md-input-wrapper">'
