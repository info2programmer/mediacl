          ...
          <div class="card-block">
			...
			?>
              <tr>
                ...
                Purchase Price(wogst) : <?php echo $p_details[0]['item_single_p_wogst']; ?>/<?php echo $unit[0]['stname']; ?><br/>
                Purchase Price(wgst) : <?php echo $p_details[0]['item_single_p_wgst']; ?>/<?php echo $unit[0]['stname']; ?>
                </td>
                <td>SGST : <?php echo $row['item_s_gst']; ?> (Rs . <?php echo $row['item_s_gst_amt']; ?>)<br/>
                CGST : <?php echo $row['item_s_cgst']; ?> (Rs . <?php echo $row['item_s_cgst_amt']; ?>)<br/>
                IGST : <?php echo $row['item_s_igst']; ?> (Rs . <?php echo $row['item_s_igst_amt']; ?>)
                </td>
